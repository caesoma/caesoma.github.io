...
\begin{align} \bar{f}_{l\star} & = \mathbf{k_{l*}}^T(K+\sigma_n^2I)^{-1}\mathbf{y} \\\\ Var[\bar{f}_{l\star}] & = \mathbf{k_{l\star\star}} - \mathbf{k_{l\star}}^T(K+\sigma_n^2I)^{-1}\mathbf{k_{l\star}} \end{align}
